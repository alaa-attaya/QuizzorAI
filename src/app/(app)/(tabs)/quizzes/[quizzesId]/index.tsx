// src/pages/quizzes/[quizzesId]/index.tsx
...
export default function QuizPage() {
  ...
  const params = useLocalSearchParams<{ quizzesId?: string }>();
  const { supabase, session } = useSupabase();
  const id = params.quizzesId;
  ...
  const handleEdit = () => {
    if (!quiz) return;
    router.replace(`/quizzes/edit-quiz?id=${quiz.id}`);
